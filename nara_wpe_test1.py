...
os.chdir('C:/Users/Spirelab/Desktop/Vowel_Triangle/REVxDEV_Exps')
...
reverb_dir = 'C:/Users/Spirelab/Desktop/Vowel_Triangle/REVxDEV_Exps/Reverbed'

folders = os.listdir(reverb_dir)

audio_file, sr = librosa.load('C:/Users/Spirelab/Desktop/Vowel_Triangle/Reverb/tmprvb_58782/ay_68577_201_rvb_largeroom1_far_angla.wav' , sr = None)

audio_file = audio_file.transpose()

tmp = np.broadcast_to(audio_file, [1, len(audio_file)])

Y_tmp = stft(tmp, size = 1024, shift = 128)
...
z_tmp = istft(Z_tmp, size = 1024 , shift = 128)

z_tmp = z_tmp.transpose()
...
sf.write('C:/Users/Spirelab/Desktop/drv_ay_68577_201_rvb_largeroom1_far_angla.wav', z_tmp , 16000)
